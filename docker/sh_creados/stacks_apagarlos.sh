...
msg "*******************************************************" "$LOGFILE"
msg "[$(date)]" "$LOGFILE"
msg "INICIO - APAGANDO SERVICIOS DE STACKS" "$LOGFILE"
msg "*******************************************************" "$LOGFILE"
...
if [ -n "$STACKS" ]; then
    ...
    msg "NO HAY STACKS CREADOS. Por lo que no puedo apagar ninguno." "$LOGFILE"
fi

msg " " "$LOGFILE"
msg "*********************************************" "$LOGFILE"
msg "[$(date)]" "$LOGFILE"
msg "- FIN - APAGANDO SERVICIOS DE STACKS       " "$LOGFILE"
msg "*********************************************" "$LOGFILE"
